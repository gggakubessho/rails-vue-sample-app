...
ActiveRecord::Schema.define(version: 2020_06_26_140349) do

  create_table "tasklists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id"
